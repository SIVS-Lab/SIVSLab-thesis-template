...
\subsection*{Use ``\texttt{\textbackslash exp(x)}'' not ``\texttt{exp(x)}''.}
...
depending on the fonts may not.  Using two ascii dashes ``--'', as in \texttt{10--20} consistently gives the desired result.
